...
Feature: Modals can be closed and update course page
  ...
  Scenario: Close page modal
    ...
    Then I should see "Done" in the "[data-region='activity-information'][data-activityname='Test page name']" "css_element"
  ...
  Scenario: Close choice  modal
    ...
    Then I should see "Done" in the "[data-region='activity-information'][data-activityname='Test choice name']" "css_element"

 ...
 * @copyright  2025 Daniel Thies based on format_topics 2015 Marina Glancy
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers     \format_popups
 */
final class format_popups_test extends \advanced_testcase {
    /**
     * Tests for format_popups::get_section_name method with default section names.
     *
     * @return void
     */
    public function test_get_section_name(): void {
        ...
        $course = $generator->create_course(
            ['numsections' => $numsections, 'format' => 'popups'],
            ['createsections' => true]
        );
    ...
    /**
     * Tests for format_popups::get_section_name method with modified section names.
     *
     * @return void
     */
    ...
    /**
     * Tests for format_popups::get_default_section_name.
     *
     * @return void
     */
    ...
    public function test_update_inplace_editable(): void {
        ...
        try {
            \core_external::update_inplace_editable('format_popups', 'sectionname', $section->id, 'New section name');
        ...
        $res = \core_external::update_inplace_editable('format_popups', 'sectionname', $section->id, 'New section name');
    ...
    public function test_inplace_editable(): void {
        ...
        // Call callback format_popups_inplace_editable() directly.
        $tmpl = component_callback('format_popups', 'inplace_editable', ['sectionname', $section->id, 'Rename me again']);
    ...
    public function test_default_course_enddate(): void {
        ...
        $params = ['format' => 'popups', 'numsections' => 5, 'startdate' => 1445644800];
    ...
    public function test_get_view_url(): void {
        ...
        $generator = $this->getDataGenerator();
        $course1 = $generator->create_course(['format' => 'popups']);
    ...
    public function test_get_required_jsfiles(): void {
        ...
        $course = $generator->create_course(['format' => 'popups']);

...
/**
   ...
   */Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.init=void 0,_ajax=_interopRequireDefault(_ajax),_log=_interopRequireDefault(_log),_notification=_interopRequireDefault(_notification),_popups=_interopRequireDefault(_popups),_socket=_interopRequireDefault(_socket);_exports.init=(contextid,courseid,displaysection,token,throttle)=>{const socket=new Socket(contextid,token);_popups.default.init(contextid,courseid,displaysection,"format_popups");let first=!0;socket.subscribe((0,_utils.debounce)((()=>{first?first=!1:_popups.default.updatePage()}),throttle))};class Socket extends _socket.default{renewToken(contextid){_ajax.default.call([{methodname:"format_popups_renew_token",args:{contextid:contextid},done:replacement=>{_log.default.debug("Reconnecting"),this.connect(contextid,replacement.token)},fail:_notification.default.exception}])}}}));
